...
function CommandPalette() {
  const COMMANDS = [
    ...
    { id: "resume-dl", icon: "fas fa-download",  label: "Download Resume", group: "Actions", action: () => { const a = document.createElement("a"); a.href = "rogerressumeFIXED10.pdf"; a.download = true; a.click(); } },
